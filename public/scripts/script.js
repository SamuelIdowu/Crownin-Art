...
function setupFileUpload(dropZoneId, fileInputId, browseBtnId, fileListId) {
  ...
  setupFileUpload('catalogue-drop-zone', 'catalogue-file-input', 'catalogue-browse-btn', 'catalogue-file-list');
  setupFileUpload('listing-drop-zone', 'listing-file-input', 'listing-browse-btn', 'listing-file-list');
  setupFileUpload('gallery-drop-zone', 'gallery-file-input', 'gallery-browse-btn', 'gallery-file-list');
  setupFileUpload('exhibition-drop-zone', 'exhibition-file-input', 'exhibition-browse-btn', 'exhibition-file-list');
